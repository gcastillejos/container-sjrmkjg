...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sjrmkjg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sjrmkjg.containers.anotherwebservice.com/
...
```
git clone git@github.com:gcastillejos/container-sjrmkjg.git
cd container-sjrmkjg
```
...
```
docker attach container-sjrmkjg
```
